...
if __name__ == '__main__':
    ...
    imitate_models_path = 'imitate_models/100-model.pkl'
    rl_models_path = 'RL_models/75000-model.pth'
    ...
    for i in range(N_worker):
        ...
        t_start = time.time()
        env = envs.envs[i]
        finished_test,total_reward,s,length = test_mover_64_net(env, models)
        t_end = time.time()
